    ...
    <div style={{ margin: "90px 0 90px 0" }}>
      ...
      <Accordion className={styles.accordion}>
        ...
        <AccordionDetails>
          <br />
          <Typography>
            NFT란 대체불가 토큰(Non-Fungible Token)의 약자로 디지털 형태를 갖춘
            암호화 자산입니다.
          </Typography>
          <br />
          <Typography>
            대체 가능한 비트코인과 달리 각 NFT 토큰은 고유합니다.
          </Typography>
          <br />
          <Typography>
            NFT는 암호화된 거래내역을 블록체인에 영구적으로 남김으로써 고유성을
            보장합니다.
          </Typography>
          <br />
        </AccordionDetails>
      ...
      <Accordion className={styles.accordion}>
        ...
        <AccordionDetails>
          ...
          <br />
          <Typography>
            총 9개의 귀여운 동물 친구로 1,2,3티어로 나뉘어 있고 BEASTAZOO의 자체
            유전 알고리즘을 통해 1티어에서 3티어까지의 자브종을 얻을 수
            있습니다.
          </Typography>
          <br />
          <Typography>
          ...
          <br />
          <Typography>지금 바로 나만의 자브종 NFT를 만들어보세요!</Typography>
          <br />
        </AccordionDetails>
      </Accordion>
      <Accordion className={styles.accordion}>
