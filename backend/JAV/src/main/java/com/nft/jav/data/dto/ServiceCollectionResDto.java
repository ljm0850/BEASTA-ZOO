...
public class ServiceCollectionResDto {
    ...
    @Builder
    public ServiceCollectionResDto(long jav_id, long user_id, int total_page, String jav_code, int level, String jav_img_path, LocalDateTime discover_time, int discover_user_count) {
        this.jav_id = jav_id;
